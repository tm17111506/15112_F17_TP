...
def getVertScore(pos, state, player):
    ...
    for pattern in sk:
        if pattern in code: 
            score += sk[pattern]
    print("Vert Code", code, "vert", score)
    return score
...
def getNegXScore(pos, state, player):
    ...
    for pattern in sk:
        if pattern in code: score += sk[pattern]
    print("Neg X code", code, "Nx", score)
    return score
...
def getPossibleScore(pos, state, player, prevMove):
    s = copy.deepcopy(state)
    if s[pos[0]][pos[1]] == None:
        s[pos[0]][pos[1]] = player
    ws = getPosScore(pos, s, player)
    bs = getPosScore(prevMove, s, player)
    print("White, black", ws, bs)
    score =  ws + bs
    #print(player, score)
    return score
...
b = [ [  None,  None,  None,  None,  None,  None,  None,  None,  None,  None,  None ],     #0
      ...
      [  None,  None,  None,  None,  None,  "black",  None,  None,  None,  None,  None ],  #2
      [  None,  None,  None,  None,  None,  "black",  None,  None,  None,  None,  None ],  #3
      [  None,  None,  None,  None,  None,  "black",  None,  None,  None,  None,  None ],  #4
      [  None,  None,  None,  None,  None,  "black",  None,  None,  None,  None,  None ],  #5
      [  None,  None,  None,  None,  None,  "white",  None,  None,  None,  None,  None ],  #6
      [  None,  None,  None,  None,  "white",  None,  None,  None,  None,  None,  None ],  #7
      [  None,  None,  None,  "white",  None,  None,  None,  None,  None,  None,  None ],  #8
